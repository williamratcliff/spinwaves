...
void addToList(Atom *list, int index, int numNbrs, int *nbrs, double *interactions, double spin, double pos_a, double pos_b, double pos_c)
{
     ...
     //I don't think it would be safe to pass an array allocated in Cython
     //becuase of garbage collection
...
SquareMatrix *createMatrix(Atom *list, int numAtoms, int cutoffCellSize[3], double q[3], int magCellSize[3])
{
     int i, j, lk, l;
           ...
           for(j = 0; j < numAtoms; j++)
           {
                 ...
                 if(i == j)
                 {
                  ...
                  for(l = 0; l < list[i].numNeighbors; l++)
                  {
                        ...
                        l_pos[0] = l_pos[0]/magCellSize[0];
                        l_pos[1] = l_pos[1]/magCellSize[1];
                        l_pos[2] = l_pos[2]/magCellSize[2];
                        ...
                        j_pos[0] = j_pos[0]/magCellSize[0];
                        j_pos[1] = j_pos[1]/magCellSize[1];
                        j_pos[2] = j_pos[2]/magCellSize[2];
