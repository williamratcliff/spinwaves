...
def dbl_equal(d1, d2):
    if (d1-d2) < 0.00000000001 and (d2-d1) < 0.000000000001:
        return true
    return False
...
#        f.write("\nafterNorm: " + str(evec.flatten()) + "\n\n")
        ...
        for i in range(numAtoms):
            ...
            for j in range(numAtoms):
                #Why did I comment out the multiplication with the exponent?
