...
class Eigenvalue
{
   ...
   */
   ...
   //  Fortran subroutine in EISPACK.
      ...
      cout << "d1: " << d[0] << " " << d[1] << " " << d[2] << "\n";
      cout << "e initial: " << e[0] << " " << e[1] << " " << e[2] << " " << e[3] << "\n";
         

      // Householder reduction to tridiagonal form.
   
      for (int i = n-1; i > 0; i--) {
          cout << "in for loop(top):\n";
         ...
         Real scale = 0.0;
         Real h = 0.0;
         cout << "d before scale calc: " << d[0] << " " << d[1] << " " << d[2] << " " << d[3] << "\n";
         ...
         cout << "scale 0:\n";
          ...
          cout << V[3][0] << " " << V[3][1] << " " << V[3][2] << " " << V[3][3] << "\n";
            e[i] = d[i-1];
            cout << "e after first assign: " << e[0] << " " << e[1] << " " << e[2] << " " << e[3] << "\n";
            for (int j = 0; j < i; j++) {
               d[j] = V[i-1][j];
               V[i][j] = 0.0;
               V[j][i] = 0.0;
         ...
         cout << "scale not zero" << "scale = " << scale << "\n";
         //cout << V[0][0] << " " << V[0][1] << " " << V[0][2] << "\n";
         //cout << V[1][0] << " " << V[1][1] << " " << V[1][2] << "\n";
         //cout << V[2][0] << " " << V[2][1] << " " << V[2][2] << "\n";
            // Generate Householder vector.
            
            cout << "d0.5: " << d[0] << " " << d[1] << " " << d[2] << " " << d[3] << "\n";
            //cout << scale << "\n";
            
            for (int k = 0; k < i; k++) {
                cout << "d before scale: " << d[0] << " " << d[1] << " " << d[2] << " " << d[3] << "\n";
               d[k] /= scale;
               cout << "d after scale: " << d[0] << " " << d[1] << " " << d[2] << " " << d[3] << "\n";
               h += d[k] * d[k];
            }
            //cout << "d1.8: " << d[0] << " " << d[1] << " " << d[2] << "\n";
            Real f = d[i-1];
            Real g = sqrt(h);
          ...
          cout << V[3][0] << " " << V[3][1] << " " << V[3][2] << " " << V[3][3] << "\n";
            ...
            cout << "\ne2.25: " << e[0] << " " << e[1] << " " << e[2] << " " << e[3] << "\n";
            Real hh = f / (h + h);
            cout << "\nhh: " << hh << "\n";
            for (int j = 0; j < i; j++) {
               e[j] -= hh * d[j];
            }
            cout << "\nd2.5: " << d[0] << " " << d[1] << " " << d[2] << " " << d[3] << "\n";
            cout << "\ne2.5: " << e[0] << " " << e[1] << " " << e[2] << " " << e[3] << "\n";
            for (int j = 0; j < i; j++) {
               f = d[j];
               g = e[j];
               for (int k = j; k <= i-1; k++) {
         ...
         cout << "in for loop:\n";
          ...
          cout << V[2][0] << " " << V[2][1] << " " << V[2][2] << " " << V[2][3] << "\n";
          cout << V[3][0] << " " << V[3][1] << " " << V[3][2] << " " << V[3][3] << "\n";
          cout << "\nd at end of loop: " << d[0] << " " << d[1] << " " << d[2] << " " << d[3] << "\n";
      }
      cout << "before accumulating transforms:\n";
          cout << V[0][0] << " " << V[0][1] << " " << V[0][2] << " " << V[0][3] << "\n";
          cout << V[1][0] << " " << V[1][1] << " " << V[1][2] << " " << V[1][3] << "\n";
          cout << V[2][0] << " " << V[2][1] << " " << V[2][2] << " " << V[2][3] << "\n";
          cout << V[3][0] << " " << V[3][1] << " " << V[3][2] << " " << V[3][3] << "\n";
      ...
      cout << "after accumulating transforms:\n";
      cout << V[0][0] << " " << V[0][1] << " " << V[0][2] << " " << V[0][3] << "\n";
      cout << V[1][0] << " " << V[1][1] << " " << V[1][2] << " " << V[1][3] << "\n";
      cout << V[2][0] << " " << V[2][1] << " " << V[2][2] << " " << V[2][3] << "\n";
      cout << V[3][0] << " " << V[3][1] << " " << V[3][2] << " " << V[3][3] << "\n";
   ...
   //  Fortran subroutine in EISPACK.
      ...
      cout << V[3][0] << " " << V[3][1] << " " << V[3][2] << " " << V[3][3] << "\n\n\n";
             ...
             cout << "\nd3.5: " << d[0] << " " << d[1] << " " << d[2] << " " << d[3] << "\n";
       cout << "\ne3.5: " << e[0] << " " << e[1] << " " << e[2] << " " << e[3] << "\n";
       cout << "v3.5:\n";
      cout << V[0][0] << " " << V[0][1] << " " << V[0][2] << " " << V[0][3] << "\n";
      cout << V[1][0] << " " << V[1][1] << " " << V[1][2] << " " << V[1][3] << "\n";
      cout << V[2][0] << " " << V[2][1] << " " << V[2][2] << " " << V[2][3] << "\n";
      cout << V[3][0] << " " << V[3][1] << " " << V[3][2] << " " << V[3][3] << "\n\n\n";
                  ...
                  cout << "\nd3.75: " << d[0] << " " << d[1] << " " << d[2] << " " << d[3] << "\n";
       cout << "\ne3.75: " << e[0] << " " << e[1] << " " << e[2] << " " << e[3] << "\n";
       cout << "v3.75:\n";
      cout << V[0][0] << " " << V[0][1] << " " << V[0][2] << " " << V[0][3] << "\n";
      cout << V[1][0] << " " << V[1][1] << " " << V[1][2] << " " << V[1][3] << "\n";
      cout << V[2][0] << " " << V[2][1] << " " << V[2][2] << " " << V[2][3] << "\n";
