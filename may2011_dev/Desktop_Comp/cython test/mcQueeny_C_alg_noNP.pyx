...
"""This is a modification of mcQueeny_C_alg.pyx where I replace all teh numpy arrays with C arrays.  I'm doing this
becuase numpy is not working with cython off the bat and rather than make it work, and expect all users to do the same,
I think it woul dbe better to try not using it."""
...
def mcQueeny_case(interactionfile, spinfile, tau_list, temperature, 
    ...
    cdef int j,i,n,Qindex #loop variables
