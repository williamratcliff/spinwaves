...
BORN_KERNEL32 = loadkernelsrc('kernelshare.c', precision='float32')
BORN_KERNEL64 = loadkernelsrc('kernelshare.c', precision='float64')
    ...
    def kernel(self):
        ...
        while True:
            ...
            self.cudaBorn(nx,ny,nz,nqx,nqy,nqz,
                     ...
                     shared=32*density.dtype.itemsize*4*1,
                     **cuda_partition(n))
